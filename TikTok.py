...
g= datetime.datetime(2023, 11, 28, 23, 00 ,9)


if (x.strftime("%x"))>(g.strftime("%x")):
 print('\033[1;32m تم ايقاف الاداه راسل المطور 𝐇𝐀𝐙𝐀𝐑𝐃 لتفعيل ')
 time.sleep(1)
 print('\033[1;31m المطور𝐇𝐀𝐙𝐀𝐑𝐃')
 time.sleep(1)
 print('سيتم نقلك الى قناة المطور بعد 10 ثواني')
 time.sleep(1)
 print('\033[1;31m 1')
 time.sleep(1)
 print('\033[1;32m 2')
